...
- Platform-generated verification codes for new account activation
- Local preview outbox for operational notifications
...
- New account verification codes are generated by the platform and shown on the verification screen.
...
Signup activation does not require Gmail, SMTP, or external email delivery. After registration, the user opens the activation tab, clicks `Generate OTP`, and enters the six-digit code displayed by the website.
