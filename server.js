...
function buildDashboardSummary(user, store) {
  ...
  return {
    ...
    contracts,
    availablePlans: store.plans.map((plan) => ({
      id: plan.id,
      name: plan.name,
      ...
      deploymentWindowDays: plan.deploymentWindowDays,
      paymentUrl: plan.paymentUrl || null,
      featuredDailyUsd: plan.featuredDailyUsd || null,
      featuredMonthlyUsd: plan.featuredMonthlyUsd || null,
